...
public class SearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String key = request.getParameter("search-name");
        String fromprice_raw = request.getParameter("price-from");
        String toprice_raw = request.getParameter("price-to");
        String search_address = request.getParameter("search-address");
        ...
        try {
            ...
            List<Room> list = md.search(key, price1, price2, search_address);
