 ...
 * @author MM
 */
public class IgnoreRoom extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet IgnoreRoom</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet IgnoreRoom at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            message.setSubject("Chủ trọ đã không phê duyệt bạn", "UTF-8");
            message.setText("Vui lòng kiểm tra lại thông tin hoặc liên lạc với chủ trọ để biết thêm thông tin.", "UTF-8");
            // send message
